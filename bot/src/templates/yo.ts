...
export const yo: TemplateSet = {
  ...
  strings: {
    ...
    locationNotRecognized:
      "A dupe, a ko le so eyi pọ mọ ibi ti a n bo lọwọlọwọ. Lọwọlọwọ a n bo Kogi, Benue, Adamawa, Anambra ati Lagos nikan, ni eba odo Niger, Benue ati Ogun. Gbiyanju oruko LGA re, tabi fi ipo re ranse.",
    ...
    outsideCoverage: "O ṣeun fun ifẹ rẹ! A n bo Kogi, Benue, Adamawa, Anambra ati Lagos nikan lọwọlọwọ, ni eba odo Niger, Benue ati Ogun. A o fun o ni imọran nigba ti a ba faagun.",
