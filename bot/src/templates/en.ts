...
export const en: TemplateSet = {
  ...
  strings: {
    ...
    locationNotRecognized:
      "Sorry, we couldn't match that to a location we cover yet. Right now we only cover communities in Kogi, Benue, Adamawa and Anambra, along the Niger and Benue rivers. Try your LGA name, or share your location pin.",
    ...
    outsideCoverage: "Thanks for your interest! We only cover Kogi, Benue, Adamawa and Anambra along the Niger and Benue rivers right now. We'll let you know when we expand.",
