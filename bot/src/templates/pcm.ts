...
export const pcm: TemplateSet = {
  ...
  strings: {
    ...
    locationNotRecognized:
      'Sorry, we no fit match that to any location wey we dey cover now. Right now na Kogi, Benue, Adamawa and Anambra we dey cover, near Niger and Benue river. Try your LGA name, or share your location pin.',
    ...
    outsideCoverage: "Thank you for your interest! Na only Kogi, Benue, Adamawa and Anambra near Niger and Benue river we dey cover now. We go tell you when we expand.",
