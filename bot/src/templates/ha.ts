...
export const ha: TemplateSet = {
  ...
  strings: {
    ...
    locationNotRecognized:
      "Yi hakuri, ba mu iya daidaita wannan da wani wuri da muke rufewa ba tukuna. A yanzu muna rufe Kogi, Benue, Adamawa da Anambra kawai, kusa da kogunan Neja da Benue. Gwada sunan LGA naka, ko ka aiko wurin da kake.",
    ...
    outsideCoverage: "Na gode da sha'awarka! A yanzu muna rufe Kogi, Benue, Adamawa da Anambra ne kawai, kusa da kogunan Neja da Benue. Za mu sanar da kai idan mun fadada.",
