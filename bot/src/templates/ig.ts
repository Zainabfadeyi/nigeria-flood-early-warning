...
export const ig: TemplateSet = {
  ...
  strings: {
    ...
    locationNotRecognized:
      "Ndo, anyị enweghị ike ijikọta nke a na ebe anyị na-ekpuchi ugbu a. Ugbu a, anyị na-ekpuchi naanị Kogi, Benue, Adamawa, Anambra na Lagos, n'akụkụ osimiri Niger, Benue na Ogun. Nwaa aha LGA gị, ma ọ bụ zitere anyị ebe ị nọ.",
    ...
    outsideCoverage: "Daalụ maka mmasị gị! Anyị na-ekpuchi naanị Kogi, Benue, Adamawa, Anambra na Lagos ugbu a, n'akụkụ osimiri Niger, Benue na Ogun. Anyị ga-agwa gị mgbe anyị gbasaworo.",
